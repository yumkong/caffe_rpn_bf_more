...
namespace caffe {
  ...
  /**
	 ...
	 */
	template <typename Dtype>
	class ClfAnnotatorOHEMLayer :public Layer<Dtype>{
	public:
	  explicit ClfAnnotatorOHEMLayer(const LayerParameter& param)
		: Layer<Dtype>(param) {}
	  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
		const vector<Blob<Dtype>*>& top);
	  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
	  ...
	  virtual inline const char* type() const { return "ClfAnnotatorOHEM"; }
   ...
   */
  template <typename Dtype>
  class RpnClsOHEMLayer :public Layer<Dtype>{
  public:
    explicit RpnClsOHEMLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
    virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
    virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
